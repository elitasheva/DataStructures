namespace CustomDictionaryTests
{
    ...
    public class CustomDictionaryTests
    {
        ...
        public void Add_EmptyHashTable_NoDuplicates_ShouldAddElement()
        {
           ...
           var dictionary = new CustomDictionary<string, int>();
            ...
            //Act
           var elements = new KeyValuePair<string, int>[]
           {
            new KeyValuePair<string, int>("Peter", 5),
            new KeyValuePair<string, int>("Maria", 6),
            new KeyValuePair<string, int>("George", 4),
            new KeyValuePair<string, int>("Kiril", 5)
           };
